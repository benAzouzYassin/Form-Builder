...
>(({ cb, className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb onClick={(e) => cb(e.target?.ariaValueNow ?? "30")} id="slider-thumb" className="block h-4 w-4 rounded-full border border-primary/50 bg-background shadow transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50" />
  </SliderPrimitive.Root>
))
