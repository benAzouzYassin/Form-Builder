...
export default function TextareaField(props: Props) {
    ...
    return <div className=" relative z-40 hover:bg-transparent hover:cursor-pointer flex-col h-[140px] justify-center bg-foreground/5 rounded-sm ring-inset ring-accent ring-2  flex  text-center transition-all hover:text-opacity-50">
