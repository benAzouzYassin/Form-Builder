...
export function DraggableElement({ children, text }: Props) {
    ...
    return <div >
        <div id={text} ref={setNodeRef} style={style} className="  p-2 z-50  hover:bg-muted-foreground/10  hover:cursor-grab flex flex-col items-center h-24 w-24 ml-auto mr-auto rounded-sm border-foreground/30 border-[1px]"  {...attributes}{...listeners}>
            {children}
