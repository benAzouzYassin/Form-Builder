...
export default async function Stats(props: Props) {
    ...
    return <div style={{ boxShadow: `2px 4px 6px 1px ${props.color}` }} className="h-40 w-64 shadow-md hover:-translate-y-1 hover:cursor-pointer transition-transform  rounded-md p-5 ">
