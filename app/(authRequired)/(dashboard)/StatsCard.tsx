...
export default async function Stats(props: Props) {
    ...
    return <Suspense fallback={<StatsCardsLoading />}>
        <div style={{ boxShadow: `2px 4px 6px 1px ${props.color}` }} className="h-36  w-72 lg:w-1/4 lg:mx-0 mx-auto shadow-md hover:-translate-y-1 hover:cursor-pointer transition-transform  rounded-md p-5 ">
