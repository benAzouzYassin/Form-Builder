...
export default function AddForm() {
    return <div className="h-44  rounded-md p-5 hover:cursor-pointer hover:bg-secondary  w-[32%]  border-2  border-opacity-50 hover:border-muted-foreground border-dashed ">
